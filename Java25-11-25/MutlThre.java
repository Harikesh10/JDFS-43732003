...
public class MutlThre {
	...
	public static void main(String[] args) {
		...
		if (num.isAlive()) {
			System.out.println("Messi thread is Alive");
		} else {
			System.out.println("Messi Thread is dead");
		}

		if (alp.isAlive()) {
			System.out.println("Ronaldo thread is Alive");
		} else {
			System.out.println("Ronaldo thread is dead");
		}
